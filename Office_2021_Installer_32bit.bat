...
REM ============================================
REM Office 2021 Silent Installer Script (32-bit)
...
REM              of Office 2021 ProPlus Volume 32-bit edition.
REM ============================================
echo ============================================
echo Office 2021 Installer Script (32-bit)
...
(
    echo ^<Configuration^>
    echo   ^<Add OfficeClientEdition="32" Channel="PerpetualVL2021"^>
